    ...
    <v-row>
      ...
      <v-col cols="12" sm="7" md="6" lg="6">
        ...
        <div class="history" :style="{ marginTop: '120px' }">
          ...
          >
          <span class="history-icon"
            ><v-icon size="60" color="primary">mdi-hammer-wrench</v-icon></span
          >
          <span class="history-icon"
            ><v-icon size="60" color="primary">mdi-car-hatchback</v-icon></span
          >
...
import PriceRemain from "./car/_id/chart/PriceRemain.vue";
import PricePredict from "./car/_id/chart/PricePredict.vue";
export default {
  computed: {
    // car() {
